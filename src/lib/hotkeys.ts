...
export const GLOBAL_SHORTCUTS = [
  { keys: "Ctrl+N", action: "New lecture (Upload)" },
...
export const HOTKEY_EVENT_NAMES = {
  toggleTranscriptPlayback: "cognote:hotkey:toggle-transcript-playback",
  previousFlashcard: "cognote:hotkey:previous-flashcard",
  nextFlashcard: "cognote:hotkey:next-flashcard",
  previousQuizQuestion: "cognote:hotkey:previous-quiz-question",
  nextQuizQuestion: "cognote:hotkey:next-quiz-question",
  stopRecording: "cognote:hotkey:stop-recording",
} as const;
